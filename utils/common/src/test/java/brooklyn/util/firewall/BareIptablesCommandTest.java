...
public class BareIptablesCommandTest {

    private static IptablesBasedCommand iptablesBasedCommand = new BareIptablesCommand();
    ...
    public void testCleanUpIptablesRules() {
        Assert.assertEquals(iptablesBasedCommand.cleanUpIptablesRules(), cleanUptptablesRules);
    }

    @Test
    public void testInsertIptablesRules() {
        Assert.assertEquals(iptablesBasedCommand.insertIptablesRule(IptablesBasedCommand.Chain.INPUT, "eth0", IptablesBasedCommand.Protocol.TCP, 3306, IptablesBasedCommand.Policy.ACCEPT),
                insertIptablesRule);
    }

    @Test
    public void testAppendIptablesRules() {
        Assert.assertEquals(iptablesBasedCommand.appendIptablesRule(IptablesBasedCommand.Chain.INPUT, "eth0", IptablesBasedCommand.Protocol.TCP, 3306, IptablesBasedCommand.Policy.ACCEPT),
                appendIptablesRule);
    }

    @Test
    public void testInsertIptablesRulesForAllInterfaces() {
        Assert.assertEquals(iptablesBasedCommand.insertIptablesRule(IptablesBasedCommand.Chain.INPUT, IptablesBasedCommand.Protocol.TCP, 3306, IptablesBasedCommand.Policy.ACCEPT),
                insertIptablesRuleAll);
    }

    @Test
    public void testAppendIptablesRulesForAllInterfaces() {
        Assert.assertEquals(iptablesBasedCommand.appendIptablesRule(IptablesBasedCommand.Chain.INPUT, IptablesBasedCommand.Protocol.TCP, 3306, IptablesBasedCommand.Policy.ACCEPT),
                appendIptablesRuleAll);
    }

    @Test
    public void testSaveIptablesRules() {
        Assert.assertEquals(iptablesBasedCommand.saveIptablesRules(), saveIptablesRules);
    }
}
