...
public abstract class IptablesBasedCommand {
     ...
     *         rules.
     */
    public String insertIptablesRule(Chain chain, brooklyn.util.net.Protocol protocol, int port, Policy policy) {
    ...
    @Deprecated
    public String insertIptablesRule(Chain chain, Protocol protocol, int port, Policy policy) {
     ...
     *         rules.
     */
    public String insertIptablesRule(Chain chain, String networkInterface, brooklyn.util.net.Protocol protocol, int port, Policy policy) {
    ...
    @Deprecated
    public String insertIptablesRule(Chain chain, String networkInterface, Protocol protocol, int port, Policy policy) {
     ...
     */
    public String appendIptablesRule(Chain chain, brooklyn.util.net.Protocol protocol, int port, Policy policy) {
    ...
    @Deprecated
    public String appendIptablesRule(Chain chain, Protocol protocol, int port, Policy policy) {
     ...
     * @return Returns the command that appends a rule to iptables.
     */
    public String appendIptablesRule(Chain chain, String networkInterface, brooklyn.util.net.Protocol protocol, int port, Policy policy) {
    ...
    @Deprecated
    public String appendIptablesRule(Chain chain, String networkInterface, Protocol protocol, int port, Policy policy) {
     ...
     */
    public String addIptablesRule(String direction, Chain chain, Optional<String> networkInterface, brooklyn.util.net.Protocol protocol, int port, Policy policy) {
    ...
    @Deprecated
    public String addIptablesRule(String direction, Chain chain, Optional<String> networkInterface, Protocol protocol, int port, Policy policy) {
