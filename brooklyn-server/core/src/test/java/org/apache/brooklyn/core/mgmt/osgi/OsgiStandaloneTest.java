...
public class OsgiStandaloneTest extends OsgiTestBase {
    ...
    public void testDuplicateBundle() throws Exception {
        MavenArtifact artifact = new MavenArtifact("org.apache.brooklyn", "brooklyn-api", "jar", "0.9.0-20160121.1603-p1"); // BROOKLYN_VERSION
    ...
    public void testRemoteDuplicateBundle() throws Exception {
        helperDuplicateBundle(MavenRetriever.hostedUrl(new MavenArtifact("org.apache.brooklyn", "brooklyn-api", "jar", "0.9.0-20160121.1603-p1"))); // BROOKLYN_VERSION
    }
